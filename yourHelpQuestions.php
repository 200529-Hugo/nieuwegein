...
$liqry = $con->prepare("SELECT id, name, title, category, location, info, who FROM request WHERE who = '$myaccount' ");
if ($liqry === false) {
...
?>
            <div id="cards">
                ...
                <td><?php echo '<a href="seeHelpNeeder.php?messager=' . $who . '&receiver=' . $name . '&id=' . $id . '">ello</a><br>'
                    ?></td>
            </div>
<?php
        }
